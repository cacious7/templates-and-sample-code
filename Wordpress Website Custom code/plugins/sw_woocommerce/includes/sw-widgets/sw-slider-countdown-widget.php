	...
	class sw_woo_slider_countdown_widget extends WP_Widget {
		...
		**/
		function WS_Countdown_integrateWithVC(){
			...
			vc_map( array(
			  "name" => __( "YA Woocommerce Countdown Slider", "sw_woocommerce" ),
			  ...
			  "params" => array(
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Dots", "sw_woocommerce" ),
					"param_name" => "dots",
					"value" => array( 'No' => 'false','Yes' => 'true'),
					"description" => __( "Dots", "sw_woocommerce" )
				 ),
				 array(
					"type" => "textfield",
					"holder" => "div",
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => 'layout1', 'Layout Coutdown 1' => 'layout2', 'Layout Coutdown 2' => 'layout3','Layout Coutdown 3' => 'layout4' ),
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Images Layout Coutdown 3", "sw_woocommerce" ),
					"param_name" => "images3",
					"value" => "",
					"description" => __( "Select Images Layout Coutdown 3", "sw_woocommerce" ),
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'layout4' ),
					)
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Link image layout coutdown 3", "sw_woocommerce" ),
					"param_name" => "link3",
					"value" => "",
					"description" => __( "Link image layout coutdown 3", "sw_woocommerce" ),
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'layout4' ),
					)
		...
		**/
		function WS_Shortcode_Countdown( $atts, $content = null ){
			...
			elseif( $layout == 'layout4' ){
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-countdown-slider/countdown3.php' );			
			}
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<?php } ?>>
						<?php _e('Countdown 2', 'sw_woocommerce')?>
					</option>
				</select>
			</p>  
		<?php
