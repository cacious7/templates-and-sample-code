	...
	class sw_woo_tab_slider_widget extends WP_Widget {
		...
		**/
		function SC_integrateWithVC(){
			...
			$term = array( __( 'Select Category Product', 'sw_woocommerce' ) => '' );
			foreach( $terms as $cat ){
				$term[$cat->name] = $cat -> slug;
			}		
			vc_map( array(
				"name" => __( "Woocommerce Tab Slider", "sw_woocommerce" ),
				"base" => "woo_tab_slider",
				"icon" => "icon-wpb-ytc",
				"class" => "",
				...
				array(
				 ...
				 array(
					...
					"value" => array('Latest Products' => 'latest', 'Top Rating Products' => 'rating', 'Best Sellers' => 'bestsales', 'Featured Products' => 'featured'),
				...
				array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => 'default','Layout Mobile'=>'layout3' ),
		...
		**/
		function SC_WooTab( $atts, $content = null ){
			...
			elseif( $layout == 'layout3' ){
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-woo-tab-slider/theme-mobile.php' );
			}
	...
	<?php 
		...
		public function form( $instance ) {
			...
			<p>
				...
				<br />
				<?php $allowed_key = array('bestsales' => 'Best Sellers', 'latest' => 'Latest Products', 'rating' => 'Top Rating Products', 'featured' => 'Featured Products'); ?>
