jQuery(document).ready(function($) {
	...
	jQuery(document).on('wc_backbone_modal_loaded', function() {
		...
		jQuery('.wc-modal-shipping-method-settings').find('.in_premium').after('<span class="premium_link" ><a  target="_blank" class="premium_link_ref" href="https://arosoft.se/product/shipping-zones-drawing-premium/">Premium</a></span>');
		...
		//$('#woocommerce_szbd-shipping-method_rate_mode').val('flat');
		...
		$('#woocommerce_szbd-shipping-method_max_driving_distance').each(function() {
			...
			elem2.bind("propertychange change click keyup input paste", function() {
		...
		$('#woocommerce_szbd-shipping-method_max_driving_time').each(function() {
			...
			elem3.bind("propertychange change click keyup input paste", function() {
