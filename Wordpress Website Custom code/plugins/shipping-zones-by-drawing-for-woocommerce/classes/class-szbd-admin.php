  ...
  function __construct()
    ...
    add_action( 'save_post_szbdzones', array(
      ...
      'save_post'
				 ...
				 add_action('wp_ajax_test_store_address', array($this, 'test_store_address'));
        }
 ...
 if ( isset ($_GET['tab']) && $_GET['tab'] == 'szbdtab' ) {
	 ...
	 wp_enqueue_script( 'shipping-del-aro-admin-method', SZBD_PLUGINDIRURL . '/assets/szbd-admin-method.js', array(
         'jquery'
		  ...
		  wp_enqueue_style('shipping-del-aro-admin-style', SZBD_PLUGINDIRURL . 'assets/szbd-method.css',SZBD_VERSION);
    global $pagenow, $post;
