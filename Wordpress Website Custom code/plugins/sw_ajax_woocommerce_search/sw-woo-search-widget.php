...
class sw_woo_search_widget extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'sw_woo_search', 'description' => __( 'This plugins allows users to search products in your website with the results in real time', 'sw_ajax_woocommerce_search' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'sw_woo_search' );

		/* Create the widget. */
		parent::__construct( 'sw_woo_search', __('SW Ajax WooCommerce Search', 'sw_ajax_woocommerce_search'), $widget_ops, $control_ops );
