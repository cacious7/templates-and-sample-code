	...
	class sw_resp_slider extends WP_Widget {
		...
		**/
		function RP_integrateWithVC(){
			...
			vc_map( array(
				"name" => __( "YA Responsive Post Slider", 'sw_core' ),
				"base" => "respost_slide",
				"icon" => "icon-wpb-ytc",
				"class" => "",
				...
				"params" => array(
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Header Style", 'sw_core' ),
					...
					"description" => __( "Header Style", 'sw_core' )
				 ),
				 array(
				'param_name'    => 'category',
				'type'          => 'dropdown',
				...
				'class'         => ''
				 ...
				 array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => '1','Layout 2' => '2'),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<option value="most-view" <?php if ($widget_template=='most-view'){?> selected="selected"
					<?php } ?>>
						<?php _e('Most View', 'sw_core')?>
					</option>
					<option value="related-post" <?php if ($widget_template=='related-post'){?> selected="selected"
					<?php } ?>>
