<div class="sw-instagram-gallery">
	<?php if( $title != '' ) : ?>
...
?>
		<!-- Gallery Content -->
		<div class="intagram-gallery-content col_<?php echo esc_attr( $columns ); ?>">
			<?php  foreach( $images as $i => $image ) : ?>
				<div class="item pull-left">
					<a target="_blank" href="<?php echo esc_url( $url[$i] ); ?>"><img src="<?php echo esc_url( $image->thumbnail->url );?>" alt=""/></a>
				</div>
			<?php endforeach; ?>
		</div>
	<?php } 
